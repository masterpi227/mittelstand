...
var QUERY_NAME = "taxi_sales";
// Replace this value with your Google Cloud API project ID
var PROJECT_ID = 'workshop-cloud-test-06';
...
function runQuery() {
  ...
  var request = {
    query:
        'SELECT company, SUM(trip_total) AS summe FROM [bigquery-public-data.chicago_taxi_trips.taxi_trips] WHERE company is NOT NULL GROUP BY company ORDER by summe DESC LIMIT 10'
  };
